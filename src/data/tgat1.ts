...
export const TGAT1_QUESTIONS: TGAT1Question[] = [
  ...
  },
  {
    ...
    "answer": 1,
    "correctExplanation": "ตอบข้อ 2 ในประโยคสุดท้ายของเรื่องบอกว่า 'regulatory frameworks regarding cross-border licensing... must undergo substantial harmonization before the full potential... realized' ซึ่งคำว่า harmonization แปลว่าการทำให้เป็นทิศทางเดียวกันหรือการมาตรฐานเดียวกัน (standardized)",
