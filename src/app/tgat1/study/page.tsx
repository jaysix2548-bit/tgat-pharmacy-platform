...
export default function TGAT1StudyPage() {
  const chapter = STUDY_CHAPTERS.find((c) => c.examId === "tgat1");
      ...
      <div className="max-w-4xl mx-auto relative z-10 space-y-10">
        ...
        <div className="text-center">
          <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-white to-slate-400 bg-clip-text text-transparent flex items-center justify-center gap-3">
            <BookOpen className="w-8 h-8 md:w-10 md:h-10 text-neon-blue" /> TGAT1 English Study Guide
          </h1>
          <p className="text-slate-400 mt-2 max-w-lg mx-auto text-sm md:text-base">
            เภสัชศาสตร์ TCAS2570 — กลยุทธ์การสื่อสารภาษาอังกฤษระดับสูงในการสอบ
          </p>
        </div>
        ...
        <MiniQuiz examId="tgat1" questionIds={chapter.miniQuizIds} />
      </div>
    </main>
  );
}
