...
import tgat3Data from "@/data/tgat3.json";
import type { Question } from "@/types/exam";

export default function Tgat3Exam() {
  ...
  useEffect(() => {
    // Load exam data
    setQuestions(tgat3Data as Question[]);
    setMounted(true);
  }, [setQuestions]);

  if (!mounted || questions.length === 0) return <div className="min-h-screen bg-slate-950 flex justify-center items-center text-yellow-400">Loading Exam Engine...</div>;
    ...
    <main className="min-h-screen bg-slate-950 text-slate-100 p-4 md:p-8">
      ...
      <div className="max-w-6xl mx-auto flex flex-wrap items-center justify-between gap-4 mb-8 bg-slate-900/80 backdrop-blur-md border border-slate-800 p-4 rounded-2xl sticky top-4 z-50 shadow-2xl">
        <div className="flex items-center gap-4">
          ...
          <div className="font-bold text-lg text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-orange-500">
      ...
      <div className="max-w-6xl mx-auto mb-24">
        {isFinished && (
          <div className="mb-8 p-8 bg-slate-900 border border-slate-800 rounded-3xl text-center shadow-xl">
            ...
            <div className="text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-orange-500 mb-4">
