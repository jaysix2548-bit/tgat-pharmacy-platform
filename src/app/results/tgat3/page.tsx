...
export default function TGAT3ResultsPage() {
  ...
  const examHistory = useMemo(() => getHistory("tgat3"), [getHistory]);
      ...
      <div className="max-w-5xl mx-auto relative z-10 space-y-10">
        ...
        <div className="text-center">
          <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight bg-gradient-to-r from-white via-slate-200 to-slate-400 bg-clip-text text-transparent">
            TGAT3 Workforce Competencies Analysis
          </h1>
          <p className="text-slate-400 mt-2 max-w-lg mx-auto text-sm md:text-base">
            Detailed breakdown of your Situational Judgement & Future Workplace Ethics score for Pharmacy TCAS.
          </p>
        </div>
