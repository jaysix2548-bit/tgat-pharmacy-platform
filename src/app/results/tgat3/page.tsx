...
export default function TGAT3ResultPage() {
  ...
  if (questions.length === 0) {
    return (
      <div className="min-h-screen bg-[#050b14] flex flex-col items-center justify-center text-white">
        ...
        <Link href="/tgat3" className="text-neon-blue underline">Go take the exam</Link>
      </div>
    );
  }
  ...
  const history = getHistory("tgat3");
  ...
  return (
    <main className="min-h-screen bg-[#050b14] text-white p-4 md:p-8 font-sans pb-28">
      ...
      <div className="absolute top-[-10%] right-[-10%] w-[50vw] h-[50vw] rounded-full bg-orange-500/5 blur-[120px] pointer-events-none" />
      ...
      <div className="max-w-5xl mx-auto space-y-6 relative z-10">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button onClick={() => router.push('/tgat3')} className="px-4 py-2 bg-orange-500 text-white font-bold rounded-xl text-sm flex items-center gap-2 hover:bg-orange-400 transition-all">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="md:col-span-1">
            <ScoreChart score={score} total={questions.length} label="คะแนน TGAT3" colorClass="from-orange-400 to-yellow-500" />
          </div>
          ...
          <div className="md:col-span-2 grid grid-cols-2 gap-4">
            ...
            <div className="bg-slate-900/50 p-6 rounded-3xl border border-white/10 flex flex-col justify-center col-span-2">
              <div className="flex items-center gap-2 text-slate-400 mb-4">
                <TrendingUp className="w-5 h-5" /> พัฒนาการ (TGAT3)
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-slate-900/50 p-6 md:p-8 rounded-3xl border border-white/10 shadow-xl">
            <h3 className="text-lg font-bold text-white mb-6 flex items-center gap-2">
              <BarChart2 className="w-5 h-5 text-orange-400" /> วิเคราะห์จุดอ่อนตามหัวข้อ
            </h3>
          ...
          <div className="bg-slate-900/50 p-6 md:p-8 rounded-3xl border border-white/10 shadow-xl">
            <h3 className="text-lg font-bold text-white mb-6 flex items-center gap-2">
              <BarChart2 className="w-5 h-5 text-yellow-400" /> ความแม่นยำตามระดับความยาก
            </h3>
